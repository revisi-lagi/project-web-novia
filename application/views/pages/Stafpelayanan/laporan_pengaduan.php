                ...
                <?php if (!empty($pengaduan)): ?>
                    <?php foreach ($pengaduan as $key => $item): ?>
                        <tr class="border-t border-gray-300">
                            ...
                            <td class="px-4 py-3">
                                <form method="post" action="<?= base_url('CStafpelayanan/update_status_form_pengaduan') ?>" class="flex items-center gap-2">
                            ...
                            <td class="px-4 py-3">
                                <?php if (!empty($item['tanggapan'])): ?>
                                    ...
                                    <!-- Form Edit -->
                                    <form id="edit-mode-<?= $item['id'] ?>" method="post" action="<?= base_url('CStafpelayanan/edit_tanggapan_pengaduan') ?>" class="hidden">
                                        <input type="hidden" name="id" value="<?= $item['id'] ?>">
                                ...
                                <?php else: ?>
                                    <!-- Form Tanggapan Baru -->
                                    <form method="post" action="<?= base_url('CStafpelayanan/tanggapi_pengaduan') ?>">
                                        <input type="hidden" name="id" value="<?= $item['id'] ?>">
