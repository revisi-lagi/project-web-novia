<div id="app" class="flex h-screen">
    <div class="w-[220px] px-4 bg-[#F5F5F5] border border-black">
        ...
        <div class="mt-5 flex flex-col gap-8">
            ...
            <a href="https://sepakat.tegalkab.go.id/form/responden/NDk=/MjA0" class="p-2 flex items-center gap-3 rounded-lg hover:bg-slate-400 ">
            ...
            <a href="<?= base_url('CWarga/menu_tanggapan_konsultasi') ?>" class="p-2 flex items-center gap-3 rounded-lg hover:bg-slate-400 ">
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#000000" viewBox="0 0 256 256">
                ...
                <h1 class="font-semibold">Tanggapan Konsultasi</h1>
            </a>
            ...
            <a href="<?= base_url('CWarga/menu_tanggapan_pengaduan') ?>" class="p-2 flex items-center gap-3 rounded-lg hover:bg-slate-400 ">
                ...
                <h1 class="font-semibold">Tanggapan Pengaduan</h1>
            </a>

        </div>

        <div class="mt-[200px] flex flex-col gap-5">
