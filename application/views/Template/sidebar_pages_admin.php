<div id="app" class="flex h-screen">
    <div class="w-[220px] px-4 bg-[#F5F5F5] border border-black">
        ...
        <div class="mt-5 flex flex-col gap-8">
            <a href="<?= base_url('CPages/Admin') ?>" class="p-2 flex items-center gap-3 rounded-lg hover:bg-slate-400 ">
            ...
            <a href="<?= base_url('CAdmin/menu_laporan_pengaduan') ?>" class="p-2 flex items-center gap-3 rounded-lg hover:bg-slate-400 ">
                <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" fill="#000000" viewBox="0 0 256 256">
            ...
            <a href="<?= base_url('CAdmin/menu_laporan_konsultasi') ?>" class="p-2 flex items-center gap-3 rounded-lg hover:bg-slate-400 ">
                <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" fill="#000000" viewBox="0 0 256 256">
            ...
            <a href="<?= base_url('CAdmin/menu_data_warga') ?>" class="p-2 flex items-center gap-3 rounded-lg hover:bg-slate-400 ">
                <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" fill="#000000" viewBox="0 0 256 256">
                    <path d="M244.8,150.4a8,8,0,0,1-11.2-1.6A51.6,51.6,0,0,0,192,128a8,8,0,0,1-7.37-4.89,8,8,0,0,1,0-6.22A8,8,0,0,1,192,112a24,24,0,1,0-23.24-30,8,8,0,1,1-15.5-4A40,40,0,1,1,219,117.51a67.94,67.94,0,0,1,27.43,21.68A8,8,0,0,1,244.8,150.4ZM190.92,212a8,8,0,1,1-13.84,8,57,57,0,0,0-98.16,0,8,8,0,1,1-13.84-8,72.06,72.06,0,0,1,33.74-29.92,48,48,0,1,1,58.36,0A72.06,72.06,0,0,1,190.92,212ZM128,176a32,32,0,1,0-32-32A32,32,0,0,0,128,176ZM72,120a8,8,0,0,0-8-8A24,24,0,1,1,87.24,82a8,8,0,1,0,15.5-4A40,40,0,1,0,37,117.51,67.94,67.94,0,0,0,9.6,139.19a8,8,0,1,0,12.8,9.61A51.6,51.6,0,0,1,64,128,8,8,0,0,0,72,120Z"></path>
                </svg>
                <h1 class="font-semibold">Kelola Data Warga</h1>
            </a>

            <a href="<?= base_url('CAdmin/menu_data_stafpelayanan') ?>" class="p-2 flex items-center gap-3 rounded-lg hover:bg-slate-400 ">
                <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" fill="#000000" viewBox="0 0 256 256">
                    <path d="M244.8,150.4a8,8,0,0,1-11.2-1.6A51.6,51.6,0,0,0,192,128a8,8,0,0,1-7.37-4.89,8,8,0,0,1,0-6.22A8,8,0,0,1,192,112a24,24,0,1,0-23.24-30,8,8,0,1,1-15.5-4A40,40,0,1,1,219,117.51a67.94,67.94,0,0,1,27.43,21.68A8,8,0,0,1,244.8,150.4ZM190.92,212a8,8,0,1,1-13.84,8,57,57,0,0,0-98.16,0,8,8,0,1,1-13.84-8,72.06,72.06,0,0,1,33.74-29.92,48,48,0,1,1,58.36,0A72.06,72.06,0,0,1,190.92,212ZM128,176a32,32,0,1,0-32-32A32,32,0,0,0,128,176ZM72,120a8,8,0,0,0-8-8A24,24,0,1,1,87.24,82a8,8,0,1,0,15.5-4A40,40,0,1,0,37,117.51,67.94,67.94,0,0,0,9.6,139.19a8,8,0,1,0,12.8,9.61A51.6,51.6,0,0,1,64,128,8,8,0,0,0,72,120Z"></path>
                </svg>
                <h1 class="font-semibold">Kelola Data Staff</h1>
            </a>

            <a href="<?= base_url('CAdmin/menu_cetak_laporan_pengaduan') ?>" class="p-2 flex items-center gap-3 rounded-lg hover:bg-slate-400 ">
                <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" fill="#000000" viewBox="0 0 256 256">
