                ...
                <?php if (!empty($konsultasi)): ?>
                    <?php foreach ($konsultasi as $key => $item): ?>
                        <tr class="border-t border-gray-300">
                            ...
                            <td class="px-4 py-3">
                                <form method="post" action="<?= base_url('CAdmin/update_status_form_konsultasi') ?>" class="flex items-center gap-2">
                            ...
                            <td class="px-4 py-3 flex gap-2">
                                <a href="<?= base_url('CAdmin/hapus_konsultasi/' . $item['id']); ?>" class="bg-red-500 text-white px-3 py-1 rounded-md hover:bg-red-600"
